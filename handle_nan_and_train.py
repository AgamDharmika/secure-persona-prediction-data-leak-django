...
if dataframes:
    ...
    # Handle NaN values
    final_data['Age'] = final_data['Age'].fillna(final_data['Age'].mean())  # Fill NaN in Age with mean

    final_data.dropna(subset=['Gender'], inplace=True)  # Drop rows where Gender is NaN
    ...
    joblib.dump(autoencoder, 'autoencoder_model.pkl')  # Save the model
